...
public class MainActivity extends Activity {
    ...
    // ini adalah method yang digunakan untuk memanggil TimePickerDialog.
    // TimePickerDialog akan menampilkan waktu saat dia dipanggil.
    ...
    OnTimeSetListener timeSetListener=new OnTimeSetListener()
    {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            //Disini saya mengatur satuan waktu yang digunakan hanya jam dan menit,
            // bisa juga sampai detik bahkan milisecond jika diinginkan.
